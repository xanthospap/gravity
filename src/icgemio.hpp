...
private:
    ...
    int max_degree_static_start{0};
    int max_degree_static_stop{0};
    int max_order_static_start{0};
    int max_order_static_stop{0};
    int max_degree_tv_start{0};
    int max_degree_tv_stop{0};
    int max_order_tv_start{0};
    int max_order_tv_stop{0};
